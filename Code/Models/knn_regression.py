...
def main():
    ...
    print("print error graphs")
    display_error_graphs(threemtx, ks, 'k', "k", "kNN")
    print("AVERAGE ERRORS")
    print_errors_2d_mtx(threemtx, ks)


def knn_regression(training_set, target_set, Ks, fold_no):
...
def cv_evaluation(
    ...
    for f, fold in enumerate(folds):
        ...
        threematrix = knn_regression(target_set, training_set, Ks, f)
        # print(threematrix.shape)
